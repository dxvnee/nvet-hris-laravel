        ...
        <div>
            ...
            <div class="mt-2 flex items-center gap-6">
                ...
                <div class="relative">
                    @if($user->avatar && Storage::disk('public')->exists($user->avatar))
                        <img src="{{ asset('storage/' . $user->avatar) }}" alt="Avatar"
                            ...
                            id="avatar-preview">
                    @else
                        <div class="w-24 h-24 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white text-3xl font-bold shadow-lg border-4 border-gray-200 dark:border-gray-600"
                            id="avatar-placeholder">
                            {{ strtoupper(substr($user->name, 0, 1)) }}
                        </div>
                        <img src="" alt="Avatar"
                            class="w-24 h-24 rounded-full object-cover border-4 border-gray-200 dark:border-gray-600 shadow-lg hidden"
                            id="avatar-preview">
                    @endif
                </div>
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400">JPG, PNG, GIF. Maks 2MB.</p>
                </div>
            </div>
