                    ...
                    <div x-show="open" @click.away="open = false" x-transition
                        ...
                        <div class="max-h-64 overflow-y-auto">
                            @forelse($employees as $employee)
                                @php
                                    $exists = \App\Models\Penggajian::where('user_id', $employee->id)
                                ...
                                <a href="{{ route('penggajian.create', ['user_id' => $employee->id, 'periode' => $periode]) }}"
                                    ...
                                    @if ($exists)
                                        <span
                                            class="px-2 py-1 bg-green-100 text-green-600 text-xs font-medium rounded">Sudah
                                            ada</span>
                                    @endif
                                </a>
                            @empty
                                    ...
                                    <td class="py-3 px-4 text-gray-700">
                                        ...
                                        @if ($gaji->total_menit_lembur ?? 0 > 0)
                                            <div class="text-xs text-gray-500">
                                                {{ floor(($gaji->total_menit_lembur ?? 0) / 60) }}j
