<x-app-layout>
    ...
    <div class="max-w-5xl mx-auto space-y-6">
        ...
        <!-- Form -->
        <form method="POST" action="{{ route('penggajian.update', $penggajian) }}" class="space-y-6" x-data="penggajianForm()">
            @csrf
            @method('PUT')
            ...
            <x-penggajian.lembur-section 
                :total-menit-lembur="$penggajian->total_menit_lembur ?? 0"
    ...
    <x-penggajian.form-script 
        ...
        :total-lupa-pulang="$totalLupaPulang"
        :detail="$detail"
        :lain-lain-items="$penggajian->lain_lain_items ?? []"
    />
</x-app-layout>
