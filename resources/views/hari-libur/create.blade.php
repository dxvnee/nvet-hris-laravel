                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <label class="relative">
                            <input type="radio" name="tipe" value="libur" x-model="tipe" class="peer sr-only"
                                {{ old('tipe', 'libur') === 'libur' ? 'checked' : '' }}>
                            <div
                        ...
                        <label class="relative">
                            <input type="radio" name="tipe" value="hari_khusus" x-model="tipe" class="peer sr-only"
                                {{ old('tipe') === 'hari_khusus' ? 'checked' : '' }}>
                            <div
                                class="p-4 rounded-xl border-2 cursor-pointer transition-all
                ...
                <div class="border-t border-gray-200 pt-6" x-show="tipe === 'hari_khusus'" x-transition>
                    ...
                    <div x-show="isMasuk" x-transition class="space-y-6">
                        ...
                        <div
                            ...
                            <div class="flex items-start gap-3">
                                <input type="checkbox" name="is_lembur" id="is_lembur" value="1"
                                    x-model="isLembur" {{ old('is_lembur', true) ? 'checked' : '' }}
                        ...
                        <div class="bg-gray-50 rounded-xl p-4 space-y-4">
                            <div class="flex items-start gap-3">
                                <input type="checkbox" name="is_shift_enabled" id="is_shift_enabled" value="1"
                                    x-model="isShiftEnabled" {{ old('is_shift_enabled') ? 'checked' : '' }}
                                    class="mt-1 w-5 h-5 rounded border-gray-300 text-primary focus:ring-primary">
                                <div>
                            ...
                            <div x-show="isShiftEnabled" x-transition class="space-y-4 pt-4 border-t border-gray-200">
                                ...
                                <div>
                                    <h5 class="text-sm font-semibold text-gray-700 mb-3 flex items-center gap-2">
                                        <span class="px-2 py-1 bg-green-100 text-green-700 rounded-lg text-xs">Shift
                                            1</span>
                                    </h5>
                                    <div class="grid grid-cols-2 gap-4">
                                        <div>
                                            <label class="block text-sm font-medium text-gray-600 mb-2">Jam
                                                Masuk</label>
                                            <input type="time" name="shift1_jam_masuk"
                                                value="{{ old('shift1_jam_masuk') }}"
                                                class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all">
                                        </div>
                                        <div>
                                            <label class="block text-sm font-medium text-gray-600 mb-2">Jam
                                                Keluar</label>
                                            <input type="time" name="shift1_jam_keluar"
                                                value="{{ old('shift1_jam_keluar') }}"
                                                class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    <h5 class="text-sm font-semibold text-gray-700 mb-3 flex items-center gap-2">
                                        <span class="px-2 py-1 bg-orange-100 text-orange-700 rounded-lg text-xs">Shift
                                            2</span>
                                    </h5>
                                    <div class="grid grid-cols-2 gap-4">
                                        <div>
                                            <label class="block text-sm font-medium text-gray-600 mb-2">Jam
                                                Masuk</label>
                                            <input type="time" name="shift2_jam_masuk"
                                                value="{{ old('shift2_jam_masuk') }}"
                                                class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all">
                                        </div>
                                        <div>
                                            <label class="block text-sm font-medium text-gray-600 mb-2">Jam
                                                Keluar</label>
                                            <input type="time" name="shift2_jam_keluar"
                                                value="{{ old('shift2_jam_keluar') }}"
                                                class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="bg-gray-50 rounded-xl p-4 space-y-4">
                            ...
                            <input type="hidden" name="pegawai_semua"
                                :value="pegawaiMode === 'semua' ? '1' : ''">

                            <div x-show="pegawaiMode === 'pilih'" x-transition
                                class="space-y-3 max-h-60 overflow-y-auto">
                                @foreach ($pegawai as $p)
                                    <label
                                        class="flex items-center gap-3 p-3 bg-white rounded-lg border border-gray-200 hover:border-primary/50 cursor-pointer transition-all">
                                        ...
                                        @if ($p->is_shift)
                                            <span
                                                class="ml-auto px-2 py-1 bg-purple-100 text-purple-700 rounded-lg text-xs">Shift</span>
                                        @endif
                                    </label>
                                @endforeach
                            </div>
                        ...
                        <div class="bg-gray-50 rounded-xl p-4 space-y-4">
                            ...
                            {{-- Libur Tetap Masuk --}}
                            <div class="flex items-start gap-3">
                                <input type="checkbox" name="libur_tetap_masuk" id="libur_tetap_masuk"
                                    value="1" {{ old('libur_tetap_masuk') ? 'checked' : '' }}
                                    class="mt-1 w-5 h-5 rounded border-gray-300 text-primary focus:ring-primary">
                                <div>
                            ...
                            <div x-show="isLembur" x-transition>
                                ...
                                <div class="flex items-center gap-3">
                                    <input type="number" name="upah_multiplier" id="upah_multiplier"
                                        value="{{ old('upah_multiplier', '1.0') }}" min="0.5" max="5"
                                        step="0.5"
