...
<head>
    ...
    <title>Slip Gaji - {{ $penggajian->user->name }} - {{ \Carbon\Carbon::parse($penggajian->periode)->format('F Y') }}
    </title>
...
<body>
    ...
    <div class="container">
        ...
        <!-- Section 1: Gaji Pokok & Potongan & Lain-lain -->
        <x-penggajian.print.gaji-pokok :penggajian="$penggajian" />

        <!-- Section 2: Insentif & Lembur -->
    ...
    <button class="print-button no-print" onclick="window.print()">
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <path
                d="M6,18 L4,18 C2.9,18 2,17.1 2,16 L2,11 C2,9.9 2.9,9 4,9 L20,9 C21.1,9 22,9.9 22,11 L22,16 C22,17.1 21.1,18 20,18 L18,18">
            </path>
