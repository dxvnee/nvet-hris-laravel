    ...
    <div class="flex w-full justify-center items-center p-6 relative z-10">
        <div class="flex flex-col items-center gap-2 animate-fade-in">
            ...
            <div class="flex gap-4 mt-2">
                <a href="https://www.instagram.com/nvetties.id/" class="text-white/70 hover:text-white transition-colors duration-300">
                ...
                <a href="https://www.linkedin.com/in/natura-virtue-833242390/" class="text-white/70 hover:text-white transition-colors duration-300">
