...
<div id="camera-modal" class="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 p-4 hidden">
        ...
        <div class="bg-white rounded-3xl shadow-2xl w-full max-w-lg transform transition-all animate-slide-up">
            <div class="p-6">
                ...
                <div class="flex items-center justify-between mb-6">
                    ...
                    <x-ui.action-button type="button" onclick="closeCameraModal()" variant="ghost" class="!p-2">
                ...
                <div class="flex gap-3">
                    <x-ui.action-button type="button" id="btn-capture" onclick="capturePhoto()" variant="primary"
                        iconName="camera" class="flex-1">
                        Ambil Foto
                    </x-ui.action-button>
                    <x-ui.action-button type="button" id="btn-retake" onclick="retakePhoto()" variant="secondary"
                        iconName="refresh" class="hidden flex-1">
                        Ulangi
                    </x-ui.action-button>
                </div>
                ...
                {{-- Submit Button --}}
                <x-ui.action-button type="button" id="btn-submit" onclick="submitWithPhoto()" variant="success"
                    iconName="check" class="w-full mt-4">
                ...
                <div id="izin-keterangan-wrapper" class="hidden mt-4">
                    ...
                    <x-ui.form-input type="textarea" name="izin-keterangan-input" id="izin-keterangan-input"
                        rows="3" placeholder="Masukkan alasan..." class="!mb-0" />
                </div>
                ...
                <div id="diluar-lokasi-wrapper" class="hidden mt-4">
                    ...
                    <x-ui.form-input type="textarea" name="diluar-lokasi-input" id="diluar-lokasi-input"
                        rows="3"
                        placeholder="Contoh: Sedang visit ke klien, meeting di luar kantor, dinas luar, dll..."
                        class="!mb-0" />
                </div>
            </div>
        </div>
