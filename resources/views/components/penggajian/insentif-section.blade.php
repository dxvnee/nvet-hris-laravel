...
<x-penggajian.form-section 
    title="Insentif - {{ $jabatan }}"
    subtitle="Komponen insentif berdasarkan jabatan"
    icon-color="green"
...
>
    ...
    @elseif($jabatan === 'Paramedis')
        <x-penggajian.insentif-paramedis :detail="$detail" />
    @elseif($jabatan === 'FO')
        <x-penggajian.insentif-fo :detail="$detail" />
    @elseif($jabatan === 'Tech')
        <x-penggajian.insentif-tech :detail="$detail" />
    @endif
</x-penggajian.form-section>
